    ...
    // you may use the following color schemes
            ...
            // --surface:    rgba(255, 255, 255, 0.82);    // <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" />
    // <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
    //UI missing
...
let map;
        ...
        function updateCompassDisplay() {
            const heading = typeof currentHeading === 'number' && !isNaN(currentHeading) ? currentHeading : 0;
            ...
            if (compassHeading) {
                compassHeading.innerHTML = `${Math.round(heading)}°`;
            }
        }
        ...
        function loadGeoJSONOverlays() {
            fetch('/files/main.geojson')
                    ...
                    L.geoJSON(data, {
                        pointToLayer: (feature, latlng) => {
                            return L.circleMarker(latlng, {
                                ...
                                opacity: 0.8,
                                fillOpacity: 0.7
                            }).bindPopup(`<strong>${feature.properties.name || 'Location'}</strong><br/>${feature.properties.type || ''}`);
                        },
                        style: (feature) => {
                            return {
                                color: "#C8F135",
                ...
                .catch(err => console.log('GeoJSON load error:', err));
        }
        ...
        window.addEventListener('load', () => {
            ...
            startGPS();
            initHeadingSensors();
            updateCompassDisplay();  // Initialize compass display
            checkNetworkStatus();
